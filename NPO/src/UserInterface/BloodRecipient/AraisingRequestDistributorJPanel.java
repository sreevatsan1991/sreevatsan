...
public class AraisingRequestDistributorJPanel extends javax.swing.JPanel {
    ...
    AraisingRequestDistributorJPanel(JPanel userProcessContainer, BloodRecipientOrganization organization, OrganizationDirectory od, BloodRecipient bloodRecipient, UserAccount account, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Requesting Blood Groups");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        BloodRecipientWorkAreaJPanel rwajp = (BloodRecipientWorkAreaJPanel) component;
...
// TODO add your handling code here:
 ...
 try {
            ...
            Integer AB = Integer.parseInt(txtAB.getText());
            Integer O = Integer.parseInt(txtO.getText());
           

            BloodDetails bd = bloodRecipient.getBloodDetailsHistory().addBloodDetails();
            bd.setBloodTypeA(A);
            bd.setBloodTypeB(B);
            ...
            dr.setBloodRecipient(bloodRecipient);
