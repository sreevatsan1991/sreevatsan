 ...
 * @author Malick
 */
public class BloodRecipientWorkAreaJPanel extends javax.swing.JPanel {
    
    private JPanel userProcessContainer;
    private Enterprise enterprise;
    private UserAccount account;
    private BloodRecipientOrganization organization;
    ...
    public BloodRecipientWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, BloodRecipientOrganization organization, Network network, EcoSystem var6, Enterprise enterprise) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : account.getWorkQueue().getWorkRequestList()){
            ...
            Integer A = ((BloodDistributorWorkRequest) request).getBloodDetails().getBloodTypeA();
            Integer B = ((BloodDistributorWorkRequest) request).getBloodDetails().getBloodTypeB();
            Integer AB = ((BloodDistributorWorkRequest) request).getBloodDetails().getBloodTypeAB();
            Integer O = ((BloodDistributorWorkRequest) request).getBloodDetails().getBloodTypeO();
            Integer q = ((BloodDistributorWorkRequest) request).getBloodDetails().getTotalQuantity();
            row[1] = request.getMessage();
            row[2] = request.getStatus();
            String result = ((BloodDistributorWorkRequest) request).getTestResult();
 ...
 public void refreshRecipientTable(){
        ...
        /*for(int i = rowcount-1;i>=0;i--)
        {
         ...
         for(Organization org:enterprise.getOrganizationDirectory().getOrganizationList()){
            if(Organization.Type.BloodRecipient.getValue().equals(org.getName())){
                 for(BloodRecipient bd:org.getEmployeeDirectory().getBloodRecipientList()){
                    {
    ...
    private void initComponents() {
        ...
        tableRecipientCollector.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Needed Quantity", "A", "B", "AB", "O", "Status", "Result"
            }
        ) {
        ...
        btnAraiseRequest.setText("Araise Request");
    ...
    private void btnAraiseRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAraiseRequestActionPerformed
        ...
        if(SelectedRow>=0)
        {
            BloodRecipient e2 =(BloodRecipient) recTable.getValueAt(SelectedRow,0);
    ...
    private void addRecBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRecBtnActionPerformed
        ...
        AddBloodRecipientJPanel don = new AddBloodRecipientJPanel(userProcessContainer,od,enterprise,account);
