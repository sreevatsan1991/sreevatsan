 ...
 * @author Malick
 */
public class BloodLabWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private UserAccount account;
    private BloodLabOrganization organization; 
    ...
    public BloodLabWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, BloodLabOrganization organization, Enterprise enterprise) {
        initComponents();
        ...
        for(WorkRequest wr : account.getWorkQueue().getWorkRequestList()){
          if(wr.getReceiver()==null){
            ...
            if(wr.getReceiver().equals(account)){
               BloodLabWorkRequest lwr = (BloodLabWorkRequest) wr;
    ...
    private void initComponents() {
        ...
        requestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request ID", "Availability", "Message", "Sender", "Assigned to", "Status"
            }
        ) {
...
for(WorkRequest wr:account.getWorkQueue().getWorkRequestList())
            {
                ...
                if(wr.getReceiver().equals(account))
                {
                BloodLabWorkRequest lr = (BloodLabWorkRequest) wr;
                
               if(lr.getMessage().equals(requestJTable.getValueAt(selectedRow, 0)));
                lr.setStatus("Processing");
                    BloodLabTestJPanel panel = new BloodLabTestJPanel(userProcessContainer,lr,account,enterprise);
                    userProcessContainer.add("LabTest", panel);
