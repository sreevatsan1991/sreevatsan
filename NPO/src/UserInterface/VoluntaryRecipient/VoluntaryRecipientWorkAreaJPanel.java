...
import Business.WorkQueue.VoluntaryRecipientWorkRequest;
 ...
 * @author Malick
 */
public class VoluntaryRecipientWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public VoluntaryRecipientWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, VoluntaryRecipientOrganization organization, Network network, EcoSystem var6, Enterprise enterprise) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : account.getWorkQueue().getWorkRequestList()){
            ...
            Integer A = ((VoluntaryDistributorWorkRequest) request).getVoluntaryDetails().getVoluntaryCleanlinessType();
            Integer B = ((VoluntaryDistributorWorkRequest) request).getVoluntaryDetails().getVoluntarySocailAwarenessType();
            Integer C = ((VoluntaryDistributorWorkRequest) request).getVoluntaryDetails().getVoluntaryMedicatingType();
            Integer D = ((VoluntaryDistributorWorkRequest) request).getVoluntaryDetails().getVoluntaryGreenPlantationType();
            Integer Q = ((VoluntaryDistributorWorkRequest) request).getVoluntaryDetails().getTotalQuantity();
            row[1] = request.getMessage();
            row[2] = request.getStatus();
            String result = ((VoluntaryDistributorWorkRequest) request).getTestResult();
 ...
 public void refreshRecipientTable(){
        ...
        /*for(int i = rowcount-1;i>=0;i--)
        {
         ...
         for(Organization org:enterprise.getOrganizationDirectory().getOrganizationList()){
            if(Organization.Type.VoluntaryRecipient.getValue().equals(org.getName())){
                 for(VoluntaryRecipient bd:org.getEmployeeDirectory().getVoluntaryRecipientList()){
                    {
    ...
    private void initComponents() {
        ...
        tableRecipientCollector.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Needed Quantity", "Cleaning", "Awareness", "Medical", "Planting", "Status", "Result"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class
            };
    ...
    private void btnAraiseRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAraiseRequestActionPerformed
        ...
        if(SelectedRow>=0)
        {
            VoluntaryRecipient e2 =(VoluntaryRecipient) recTable.getValueAt(SelectedRow,0);
    ...
    private void addRecBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRecBtnActionPerformed
        ...
        AddVoluntaryRecipientJPanel don = new AddVoluntaryRecipientJPanel(userProcessContainer,od,enterprise,account);
        userProcessContainer.add("AddBloodRecipient",don);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
