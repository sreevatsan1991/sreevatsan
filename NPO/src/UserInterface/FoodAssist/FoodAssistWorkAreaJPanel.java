 ...
 * @author Malick
 */
public class FoodAssistWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private UserAccount account;
    private FoodAssistOrganization organization; 
    ...
    public FoodAssistWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, FoodAssistOrganization organization, Enterprise enterprise) {
        initComponents();
...
for(WorkRequest wr:account.getWorkQueue().getWorkRequestList())
            {
                ...
                if(wr.getReceiver().equals(account))
                {
                FoodAssistWorkRequest lr = (FoodAssistWorkRequest) wr;
                
               if(lr.getMessage().equals(requestJTable.getValueAt(selectedRow, 0)));
                lr.setStatus("Processing");
                    FoodAssistTestJPanel panel = new FoodAssistTestJPanel(userProcessContainer,lr,account,enterprise);
                    userProcessContainer.add("FoodAssistTest", panel);
