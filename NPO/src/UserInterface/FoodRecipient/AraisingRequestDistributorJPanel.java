...
public class AraisingRequestDistributorJPanel extends javax.swing.JPanel {
    ...
    AraisingRequestDistributorJPanel(JPanel userProcessContainer, FoodRecipientOrganization organization, OrganizationDirectory od, FoodRecipient foodRecipient, UserAccount account, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Requesting Food");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        FoodRecipientWorkAreaJPanel rwajp = (FoodRecipientWorkAreaJPanel) component;
...
// TODO add your handling code here:
 ...
 try {
    ...
    //        Integer O = Integer.parseInt(txtO.getText());
            ...
            FoodDetails fd = foodRecipient.getFoodDetailsHistory().addFoodDetails();
            fd.setFoodPerishableType(A);
            fd.setFoodPreservedType(B);
            fd.setFoodFruitsType(C);
    //        fd.setFoodTypeO(O);
            fd.setTotalQuantity(totalQuantity);
            JOptionPane.showMessageDialog(null, "done Successfully");
            FoodDistributorWorkRequest dr = new FoodDistributorWorkRequest();
            dr.setMessage("Proceed for Distribution ");
            dr.setSender(account);
            dr.setStatus("Unassigned");
            dr.setRequestDate(new Date());
            dr.setFoodRecipient(foodRecipient);
            dr.setFoodDetails(fd);
            dr.setReceiver(null);
