 ...
 * @author vs
 */
public class AddFoodRecipientJPanel extends javax.swing.JPanel {
...
private UserAccount account;
     ...
     */
   AddFoodRecipientJPanel(JPanel userProcessContainer, OrganizationDirectory od, Enterprise enterprise, UserAccount account) {
       initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FoodRecipientWorkAreaJPanel m = (FoodRecipientWorkAreaJPanel) component;
         ...
         for(Organization org:enterprise.getOrganizationDirectory().getOrganizationList())
            {
               if(Organization.Type.FoodRecipient.getValue().equals(org.getName())) 
               {
                   ...
                   FoodRecipient foodRecipient = new FoodRecipient();
                   foodRecipient.setFoodRecipientName(recipientName);
                   org.getEmployeeDirectory().getFoodRecipientList().add(foodRecipient);
                   JOptionPane.showMessageDialog(null, "Food Recipient added successfully");
               }
            }
