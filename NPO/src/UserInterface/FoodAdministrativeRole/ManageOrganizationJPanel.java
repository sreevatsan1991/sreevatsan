...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
            if ((type.getValue().equals(Type.FoodDonor.getValue())) || (type.getValue().equals(Type.FoodRecipient.getValue())) ||
                    (type.getValue().equals(Type.FoodDistributor.getValue())) || (type.getValue().equals(Type.FoodAssist.getValue())))
        {
