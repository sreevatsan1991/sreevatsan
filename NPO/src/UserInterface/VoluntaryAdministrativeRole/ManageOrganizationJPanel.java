...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
            if ((type.getValue().equals(Type.VoluntaryDonor.getValue())) || (type.getValue().equals(Type.VoluntaryRecipient.getValue())) ||
                    (type.getValue().equals(Type.VoluntaryDistributor.getValue())) || (type.getValue().equals(Type.VoluntaryAssist.getValue())))
        {
