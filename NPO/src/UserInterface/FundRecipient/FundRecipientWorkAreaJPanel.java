...
import Business.WorkQueue.FundRecipientWorkRequest;
 ...
 * @author Malick
 */
public class FundRecipientWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public FundRecipientWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, FundRecipientOrganization organization, Network network, EcoSystem var6, Enterprise enterprise) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        for (WorkRequest request : account.getWorkQueue().getWorkRequestList()){
            ...
            Integer A = ((FundDistributorWorkRequest) request).getFundDetails().getFundEducationType();
            Integer B = ((FundDistributorWorkRequest) request).getFundDetails().getFundMedicalTreatmentType();
            Integer C = ((FundDistributorWorkRequest) request).getFundDetails().getFundRuralDevelopmentType();            
            Integer q = ((FundDistributorWorkRequest) request).getFundDetails().getTotalQuantity();
            row[1] = request.getMessage();
            row[2] = request.getStatus();
            String result = ((FundDistributorWorkRequest) request).getTestResult();
 ...
 public void refreshRecipientTable(){
        ...
        /*for(int i = rowcount-1;i>=0;i--)
        {
         ...
         for(Organization org:enterprise.getOrganizationDirectory().getOrganizationList()){
            if(Organization.Type.FundRecipient.getValue().equals(org.getName())){
                 for(FundRecipient bd:org.getEmployeeDirectory().getFundRecipientList()){
                    {
    ...
    private void initComponents() {
        ...
        tableRecipientCollector.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Needed Quantity", "Edu", "Rural", "Med", "Status", "Result"
            }
        ) {
    ...
    private void btnAraiseRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAraiseRequestActionPerformed
        ...
        if(SelectedRow>=0)
        {
            FundRecipient e2 =(FundRecipient) recTable.getValueAt(SelectedRow,0);
    ...
    private void addRecBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRecBtnActionPerformed
        ...
        AddFundRecipientJPanel don = new AddFundRecipientJPanel(userProcessContainer,od,enterprise,account);
        userProcessContainer.add("AddFundRecipient",don);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
